...
Gf ; No Gf 
Blood Group; A+
Tool Work: TikTok idx Report 
''',style='''bold Red'''))
print('[+] 1-ALL REPORT')
print('[+] 2-CHOSSE REPORT \n')
...
''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thanks For your Information "},"errMsg":"Thanks For your Information "}' in req1:
            print('\033[1;92m[+] Bzhe BATA report rooy')
        else:
            print('\033[0;92m[+] OKI REPORT')
        time.sleep(3)
        req2 = requests.post(url2, json=data2, headers=headers2).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thanks For your Information "},"errMsg":"Thanks For your Information "}' in req2:
            print('\033[1;92m[+] Report Work Done 👍🏻')
        else:
            print('\033[0;31m[+] Report Work Done 👍🏻')
        time.sleep(3)
        req3 = requests.post(url3, json=data3, headers=headers3).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thanks For your Information "},"errMsg":"Thanks For your Information "}' in req3:
            print('\033[0;92m[+] Report Work Done 👍🏻')
        else:
            print('\033[0;92m[+] Report Work Done 👍🏻')
if kurd == '2':
    print('''
...
if kurd2 == '1':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thanks For your Information "},"errMsg":"Thanks For your Information "}' in req5:
...
if kurd2 == '2':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thanks For your Information "},"errMsg":"Thanks For your Information "}' in req6:
            print('\033[1;92m[+] bzhe dark report royy')
        else:
            print('\033[0;92m[+] Report Work Done 👍🏻')
if kurd2 == '3':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"Thanks For your Information "},"errMsg":"Thanks For your Information "}' in req600:
            print('\033[1;92m[+] Report Work Done 👍🏻')
        else:
            print('\033[0;92m[+] Report Work Done 👍🏻')
